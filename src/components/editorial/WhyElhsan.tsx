...
export const WhyElhsan: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-ivory-100 border-t border-ivory-300 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {pillars.map((pillar, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-ivory-50 border border-ivory-200 hover:border-gold/50 p-8 text-center transition-all duration-500 hover:-translate-y-1 hover:shadow-xl group"
              >
                <div className="w-14 h-14 rounded-full bg-ivory-100 border border-gold/30 flex items-center justify-center mx-auto text-gold group-hover:bg-gold group-hover:text-espresso-900 transition-all duration-300 mb-6">
